...
get_attribute(get_attribute(self, "callback"), "__call__")(create_array(), {});
}
else {
...
var SUDO____init__ = function(args, kwargs) {
var signature = {"kwargs": {}, "args": create_array("self")};
var arguments = get_arguments(signature, args, kwargs);
var self = arguments["self"];
...
var SUDO__start = function(args, kwargs) {
var signature = {"kwargs": {}, "args": create_array("self")};
var arguments = get_arguments(signature, args, kwargs);
var self = arguments["self"];
var metaclass;
...
SUDO = create_class("SUDO", parents, SUDO);
sudo = get_attribute(SUDO, "__call__")(create_array(), {});
